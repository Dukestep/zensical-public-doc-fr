...
* Téléchargement de données brutes, par exemple via le [Datamart du SMC](../msc-datamart/index.md)
* Accès et téléchargement par un API, par exemple via [GeoMet du SMC](../msc-geomet/index.md))
