...
AniMet du SMC donne accès aux couches de [GeoMet-Météo et GeoMet-Climat](../msc-geomet/index.md).

## Accès

[:lucide-layers-plus: Accès à AniMet du SMC](https://eccc-msc.github.io/msc-animet/){ .md-button .md-button--primary }
...
``` mermaid
flowchart TD
    A[Ajouter des couches météorologiques et climatiques à la carte.] --> B[Personnaliser le contenu de la carte.]
    B --> C[Configurer l'animation.]
    C --> D[Créer et partager la carte et l'animation.]
...
<figure markdown="span">
  ...
  <figcaption>Configurez rapidement des vues d'analyse météorologique courantes dans le panneau de configuration.</figcaption>
</figure>


#### <span class="badge badge-info">1.2 - Couches disponibles</span>

Les utilisateurs peuvent sélectionner une couche en saisissant une variable, un système, un niveau ou en parcourant toutes les couches disponibles dans l'arborescence. Consultez la [liste des jeux de données disponibles](../msc-data/index.md) pour obtenir des informations supplémentaires sur les offres de données ouvertes du MSC.
...
!!! tip "Ensembles de données vectorielles de l'utilisateur"
...
![Fond de carte](https://collaboration.cmc.ec.gc.ca/cmc/cmos/public_doc/msc-animet/Fond_Carte_fr.jpg){ align=left }
...
AniMet du SMC exploite les données des [services web 24/7 de GeoMet du SMC](../msc-geomet/index.md). Nous encourageons les utilisateurs à s'inscrire à la liste de diffusion [GeoMet-Info](https://comm.collab.science.gc.ca/mailman3/postorius/lists/geomet-info/) pour être informés des améliorations et des changements apportés à AniMet du SMC.
...
!!! example "Code source de AniMet du SMC"
    :lucide-folder-git-2: Le code source d'AniMet du SMC est disponible publiquement sur GitHub : [https://github.com/ECCC-MSC/msc-animet](https://github.com/ECCC-MSC/msc-animet)
