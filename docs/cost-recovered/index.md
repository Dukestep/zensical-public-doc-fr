...
* :material-chart-line: **Données PNT** — Données du modèle de prévision numérique météorologique en format GRIdded Binary (GRIB2) pour des paramètres et des domaines spécifiques (jusqu'à des valeurs horaires), ou en des points spécifiques
* :material-radar: **Données radar** — Données radar brutes pour les radars canadiens, par exemple :
...
* :material-map: **Cartes météorologiques**
* :material-file-document-outline: **Bulletins en format texte**
* :material-server: **Services de données ouvertes du SMC** — La plupart des données disponibles via les services gratuits du [Datamart](../msc-datamart/index.md) et [GeoMet du SMC](../msc-geomet/index.md)

### Tarification des données radar

Les **détails concernant la tarification des données radar** sont les suivants. Veuillez noter que ces tarifs sont donnés à titre indicatif et peuvent changer.

**Données brutes** en format IRIS ou ODIM_H5

| Couverture | Prix |
|---|---|
| 1–5 radars (QC, région Atl ou Pac) | 1 600 \$/mois |
| 6–10 radars (toute une région) | 1 800 \$/mois |
| 11+ radars | 2 000 \$/mois |
| Frais d'installation uniques | 2 000 \$ |

**Produits en format ASCII**

| Couverture | Prix |
|---|---|
| 1–5 radars (QC, région Atl ou Pac) | 600 \$/mois |
| 6–10 radars (toute une région) | 700 \$/mois |
| 11+ radars | 800 \$/mois |
| Frais d'installation uniques | 800 \$ |
...
Voir aussi la [FAQ](../faq/index.md).

### Données NWP et autres données

Le **tarif de départ** concernant le service de "push" des **données NWP au format GRIB, ou toute autre donnée** :

| Volume | Prix |
|---|---|
| Jusqu'à 1 Go/jour | 500 \$/mois + 500 \$ de frais d'installation |
| Chaque Go supplémentaire par jour | +500 \$/mois |
| Modifications à un fil de données existant | 200 \$ par modification |
