...
Ces données sont disponibles via l'API / les services web [GeoMet du SMC](../../msc-geomet/index.md) :
...
* [Données CSV disponibles sur le Datamart du SMC](readme_climateltce-datamart.md)
