...
* CaPA-ARDP construit maintenant ses champs d'essai à partir du [SRPD v8.0.0](../nwp_rdps/changelog_rdps.md)
...
* Agrandissement de la grille afin de couvrir le domaine du [SRPD](../nwp_rdps/readme_rdps.md)
...
* Branchement au [SRPD v7.0.0](../nwp_rdps/changelog_rdps.md) pour obtenir son champ d'essai.
...
* Les champs d'essai de ces analyses de précipitation sont issus de la nouvelle version du système implantée le 18 septembre 2018
    * CaPA-ARDP construit maintenant ses champs d'essai à partir du [SRPD v6.0.0](../nwp_rdps/changelog_rdps.md).
