...
Ces données sont respectivement disponibles sur les services web [GeoMet du SMC](../../msc-geomet/index.md) et les services du serveur de données [Datamart du SMC](../../msc-datamart/index.md) :

* [Données courantes et d'archives disponibles sur les services web géospatiaux GeoMet-Météo](readme_rdpa-geomet.md)
...
* [Données courantes GRIB2 disponibles sur le Datamart du SMC](readme_rdpa-datamart.md) 

Un [survol et exemples pour accéder et utiliser les données ouvertes du Service météorologique du Canada](../../usage/index.md) est disponible. Exemple de carte interactive configurée pour afficher la quantité de précipitations `[mm]` au cours des dernières 24h en utilisant une couche WMS de l'Analyse régionale déterministe de précipitation (ARDP) provenant de GeoMet du SMC :
...
La chronologie des changements apportés à l'Analyse régionale déterministe de précipitation (ARDP) est disponible [ici](changelog_rdpa.md).
