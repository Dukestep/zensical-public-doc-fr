...
* Les utilisateurs peuvent visualiser les couches avec leurs propres styles en utilisant le standard Styled Layer Descriptor (SLD), veuillez vous référer à la [documentation technique sur le SLD](../../../msc-geomet/wms#specification-des-styles).
