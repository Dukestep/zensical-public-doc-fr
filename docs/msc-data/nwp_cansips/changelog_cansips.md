...
* L'initialisation de conditions de surface de GEM-NEMO provient maintenant du [Système global de prévision déterministe (SGPD)](../nwp_gdps/readme_gdps.md) après un ajustement vers la climatologie du modèle. Dans la version précédente, l'initialisation provenait de processus hors-ligne.
