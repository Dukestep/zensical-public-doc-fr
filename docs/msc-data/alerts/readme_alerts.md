...
* [Données XML disponibles sur le Datamart du SMC](readme_alerts-datamart.md)
* [Données disponibles via les services web géospatiaux GeoMet du SMC et API](../../msc-data/alerts/readme_alerts-geomet.md)
