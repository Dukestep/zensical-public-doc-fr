...
La couche des alertes météo est [disponible sur GeoMet-Météo par le biais du standard WMS (Web Map Service)](../../msc-geomet/index.md).
...
Il est possible de [filter les alertes à l'aide de CQL2](../../msc-geomet/ogc_api.md#ogc-api-filtrage-avance-avec-cql2).
