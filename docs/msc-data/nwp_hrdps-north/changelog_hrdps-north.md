...
* Améliorations aux conditions initiales et aux frontières qui proviennent d'une composante du [Système global de prévision déterministe (SGPD)](../nwp_gdps/readme_gdps.md) à 10km de résolution. 
* Mise à jour des conditions initiales de la glace de mer à partir du [Système régional de prévision océan-glace (SRPOG)](../nwp_riops/readme_riops.md), fournissant des données plus précises sur la glace de mer. 
...
* Nouveau modèle pilote: SRPD National [version 8.0.0](../nwp_rdps/changelog_rdps.md#le-mercredi-1er-decembre-2021).
