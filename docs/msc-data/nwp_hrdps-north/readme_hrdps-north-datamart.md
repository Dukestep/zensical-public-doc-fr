...
Cette page décrit toutes les données du [Système à Haute Résolution de Prévision Déterministe Nord (SHRPD-Nord)](readme_hrdps-north.md) expérimental disponibles en format GRIB2 sur une grille lat-lon tournée à 3km de résolution sur un domaine étendu.
