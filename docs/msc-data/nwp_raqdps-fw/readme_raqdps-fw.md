...
* [Données disponibles via les services web géospatiaux GeoMet-Météo](readme_raqdps-fw-geomet.md)
* [Données GRIB2 disponibles sur le Datamart du SMC](readme_raqdps-fw-datamart.md) 

Un [survol et exemples pour accéder et utiliser les données ouvertes du Service météorologique du Canada](../../usage/index.md) est disponible. Exemple de carte interactive présentant la couche `RAQDPS-FW.EATM_PM2.5-DIFF` du SRPDQA-FW provenant de GeoMet du SMC :
...
La chronologie des changements apportés aux systèmes opérationnels est disponible [le registre des changements](changelog_raqdps-fw.md).
