...
Cette page décrit à la fois les [données météorologiques à l'aviation en format IWXXM](readme_aviation-iwxxm.md) disponibles sur le Datamart du SMC mais aussi le schéma utilisé pour encoder les données spécifiques au Canada.
