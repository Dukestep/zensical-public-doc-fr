...
* [Données GRIB2 disponibles sur le Datamart du SMC](readme_hrdpa-datamart.md) 
* [Données disponibles via les services web géospatiaux GeoMet GeoMet-Météo](../../msc-geomet/index.md)
...
La chronologie des changements apportés au Système d’analyse à haute résolution déterministe de précipitation (AHRDP) est disponible [ici](changelog_hrdpa.md).
