...
Ces données sont respectivement disponibles via l'API / les services web [GeoMet du SMC](../../msc-geomet/index.md) ainsi que sur le serveur de données [Datamart du SMC](../../msc-datamart/index.md)  :

* [Données disponibles via l'API / les services web géospatiaux GeoMet-Météo](readme_geps-geomet.md)
* [Données GRIB2 disponibles sur le Datamart du SMC](readme_geps-datamart.md) 

Un [survol et exemples pour accéder et utiliser les données ouvertes du Service météorologique du Canada](../../usage/index.md) est disponible. Exemple de carte interactive présentant la couche `GEPS.DIAG.12_PRMM.ERGE10` du SGPE provenant de GeoMet du SMC :
...
La chronologie des changements apportés au Système global de prévision d'ensemble (SGPE) est disponible [ici](changelog_geps.md).
