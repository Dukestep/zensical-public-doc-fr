...
* [Données disponibles sur les services web géospatiaux GeoMet-Climat](readme_spei-geomet.md)
...
* [Données NetCDF disponibles sur le Datamart du SMC](readme_spei-datamart.md)
