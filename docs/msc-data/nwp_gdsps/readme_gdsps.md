...
* [Données disponibles via les services web géospatiaux GeoMet-Météo](readme_gdsps-geomet.md)
* [Données NetCDF disponibles sur le Datamart du SMC](readme_gdsps-datamart.md)
...
La chronologie des changements apportés au Système global de prévision déterministe d'onde de tempête (SGPDOT) est disponible [ici](changelog_gdsps.md).
