...
Ces données sont respectivement disponibles sur les API / services web [GeoMet du SMC](../../msc-geomet/index.md) ainsi que sur le serveur de données [Datamart du SMC](../../msc-datamart/index.md) :

* [Données disponibles via les services web géospatiaux GeoMet-Météo](readme_raqdps-geomet.md)
* [Données GRIB2 disponibles sur le Datamart du SMC](readme_raqdps-datamart.md) 

Un [survol et exemples pour accéder et utiliser les données ouvertes du Service météorologique du Canada](../../usage/index.md) est disponible. Exemple de carte interactive présentant la couche `RAQDPS.SFC_NO2` du SRPDQA provenant de GeoMet du SMC :
...
La chronologie des changements apportés aux systèmes opérationnels est disponible [dans le registre des changements](changelog_raqdps.md).
