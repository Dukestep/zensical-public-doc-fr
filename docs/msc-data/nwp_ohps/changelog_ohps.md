...
*  Remplacement de la prévision actuelle de l'onde de tempête basée sur l'ajustement sinusoïdal par un signal d'onde de tempête plus réaliste prévu par le [Système régional de prévision d'ensemble d'ondes de tempête (SRPEOT)](../nwp_resps/readme_resps.md) pour calculer la condition limite en aval 
