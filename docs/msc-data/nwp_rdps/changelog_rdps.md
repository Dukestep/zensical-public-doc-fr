...
* Le SRPD est remplacé par une composante du [Système global de prévision déterministe (SGPD)](../nwp_gdps/readme_gdps.md) v9.0.0, à 10 km de résolution, sur un domaine nord-américain.
...
* Changements au modèle de prévision :
    * Le [SGPD v7.0.0](../nwp_gdps/changelog_gdps.md) remplace le SGPD v6.1.0 comme modèle pilote.
...
Vous pouvez accéder à la page du SRPD [en cliquant ici](readme_rdps.md).
