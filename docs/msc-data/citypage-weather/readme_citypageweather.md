...
* [Données XML disponibles sur le Datamart du SMC](readme_citypageweather-datamart.md) 
* [Données disponibles via les services web géospatiaux GeoMet-Météo](../../msc-geomet/index.md), notamment via GeoMet-OGC-API, avec la collection expérimentale [Prévisions météorologiques par ville en temps réel](https://api.meteo.gc.ca/collections/citypageweather-realtime?lang=fr)
