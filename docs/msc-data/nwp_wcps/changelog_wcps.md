...
* Forçages atmosphériques provenant d'une composante du [Système global de prévision déterministe (SGPD)](../nwp_gdps/readme_gdps.md) à 10km de résolution horizontale
...
* Le [SRPD v8.0.0](../nwp_rdps/changelog_rdps.md) remplace le SRPD v7.1.0 comme modèle pilote
...
* Le [SRPD v7.0.0](../nwp_rdps/changelog_rdps.md) remplace le SRPD v6.0.0 comme modèle pilote.
