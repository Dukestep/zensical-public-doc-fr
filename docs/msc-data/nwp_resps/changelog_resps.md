...
*  Forçage du modèle, les données relatives au vent et à la pression au niveau de la mer ont été mises à jour pour tenir compte de la version 8.0.0 du [Système global de prévision d'ensemble (SGPE)](../nwp_geps/readme_geps.md). 
