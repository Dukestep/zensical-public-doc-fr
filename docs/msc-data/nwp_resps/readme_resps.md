...
* [Données disponibles via les services web géospatiaux GeoMet-Météo](readme_resps-geomet.md)
* [Données NetCDF disponibles sur le Datamart du SMC](readme_resps-datamart.md)
...
La chronologie des changements apportés au Système régional de prévision d'ensemble d'onde de tempête (SRPEOT) est disponible [ici](changelog_resps.md).
