...
Ces données sont respectivement disponibles sur les services web [GeoMet du SMC](../../msc-geomet/index.md) ainsi que sur le serveur de données [Datamart du SMC](../../msc-datamart/index.md) :

* [La zone de réaction aux ouragans et les trajectoires sont disponibles sur l'API de GeoMet-Météo](readme_hurricanes_geomet.md)
* [Les trajectoires sont disponibles sur le Datamart du SMC](readme_hurricanes-datamart.md)
