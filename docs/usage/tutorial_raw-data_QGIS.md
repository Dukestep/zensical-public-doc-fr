...
Il est possible d'ajouter directement des fichiers géospatiaux du [Datamart du SMC](../msc-datamart/index.md) dans QGIS en glissant et déposant un fichier dans l'interface cartographique de QGIS :
...
La même approche fonctionne également pour ajouter les fichiers bruts récupérés par les services web WCS et OGC API - Features de [GeoMet du SMC](../msc-geomet/index.md).
